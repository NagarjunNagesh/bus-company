...
import (
	...
	"bus-company/restapi/operations"
	"bus-company/restapi/operations/trip"
)

//go:generate swagger generate server --target ../../bus-company --name BusCompany --spec ../swagger.yaml --principal interface{}

func configureFlags(api *operations.BusCompanyAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.BusCompanyAPI) http.Handler {
